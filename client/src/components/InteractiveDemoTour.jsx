...
export function InteractiveDemoTour({ 
  ...
  const demoSteps = [
    ...
    },
    {
      ...
      titleEn: "Claude 3.5 Sonnet Grounded Advisor",
      titleHi: "क्लॉड 3.5 सॉनेट आधारित स्थानीय व्यापार सलाहकार",
      ...
      highlightTextEn: "Live Claude 3.5 Sonnet • Balrampur Mandi Prices • Bulletproof Safety Net Fallback",
      highlightTextHi: "लाइव क्लॉड 3.5 सॉनेट • बलरामपुर गल्ला मंडी अग्रिम बुकिंग • 6 सुरक्षित ऑफलाइन परिदृश्य",
      icon: Sparkles,
      color: "from-terracotta-600 to-amber-600",
      action: () => {
