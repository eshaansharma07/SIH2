...
export function CashFlowPage({ 
  ...
  useEffect(() => {
    try {
      const pendingTab = sessionStorage.getItem('saakhsetu_cashflow_tab');
      if (pendingTab) {
        sessionStorage.removeItem('saakhsetu_cashflow_tab');
        if (pendingTab === 'sales') {
          setSelectedCategoryTab('sales');
          setTypeFilter('income');
        } else if (pendingTab === 'purchases') {
          setSelectedCategoryTab('purchases');
          setTypeFilter('expense');
        } else if (pendingTab === 'expenses') {
          setSelectedCategoryTab('expenses');
          setTypeFilter('expense');
        } else if (pendingTab === 'udhaar') {
          setSelectedCategoryTab('udhaar');
          setTypeFilter('all');
        } else if (pendingTab === 'customers') {
          setSelectedCategoryTab('customers');
        }
      }
      const pendingFilter = sessionStorage.getItem('saakhsetu_cashflow_filter');
      if (pendingFilter) {
        sessionStorage.removeItem('saakhsetu_cashflow_filter');
        if (pendingFilter === 'income') {
          setSelectedCategoryTab('sales');
          setTypeFilter('income');
        } else if (pendingFilter === 'expense') {
          setSelectedCategoryTab('expenses');
          setTypeFilter('expense');
        }
      }
